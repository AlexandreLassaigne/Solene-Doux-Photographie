    ...
    rows: [
      {
        ...
        content:
          "La séance grossesse est à réaliser idéalement entre le 7ème et le 8ème mois de grossesse, mais elle peut se faire avant si vous le souhaitez. Elle se fait en intérieur chez vous ou en extérieur (lieu à définir).",
      },
      {
        title: "Quand faire la séance naissance ?",
        content:
          "La séance naissance est à réaliser dans le premier mois du bébé, voire même dans les deux premières semaines, afin de capturer ses petits détails de nouveau-né. Elle se déroule en intérieur chez vous, dans votre cocon.",
      },
      {
        title: "Comment m'habiller ?",
        content:
