        ...
        <main>
          <div style={{ textAlign: "center", fontFamily: "Inria serif" }}>
            ...
            <p className={styles.presentation}>
              ...
              intime, je vous accompagnerai dans ce moment de partage tout en
              créant des images authentiques et pleines de joie. <br />
      ...
      <div>
        <main>
          <div style={{ textAlign: "center", fontFamily: "Inria serif" }}>
            ...
            <p className={styles.presentation}>
              Célébrez l’un des moments les plus précieux de votre vie, en
              créant un souvenir intemporel de cette période unique.
              <br /> Mon objectif étant de capturer la beauté et la magie de
              votre grossesse, tout en vous mettant à l’aise. <br />
        ...
        <main>
          <div style={{ textAlign: "center", fontFamily: "Inria serif" }}>
            ...
            <p className={styles.presentation}>
              ...
              fragilité.
              <br /> Immortalisée dans les 30 premiers jours, cette séance
              permet de photographier votre tout-petit dans des poses naturelles
              et sécurisées, en mettant l’accent sur les détails précieux.{" "}
              <br />
              Elle se déroulera à domicile, pour que chaque photo soit réalisée
              dans le respect du bien-être de votre nouveau-né, tout en étant
              dans votre univers, pour des souvenirs tendres et intemporels.
            </p>
          </div>
          <div className={styles.container}>
            <Image
      ...
      <div>
        <main>
          <div style={{ textAlign: "center", fontFamily: "Inria serif" }}>
            ...
            <p className={styles.presentation}>
              Que vous soyez un entrepreneur, un créateur, ou que vous ayez
              besoin de photos professionnelles pour votre image de marque,
              cette séance est conçue pour répondre à vos attentes. Je vous
              propose une expérience sur-mesure, que ce soit dans votre propre
              univers, pour refléter votre personnalité ou votre activité, ou
              bien dans un cadre plus “neutre” avec des fonds simples et épurés
              pour un rendu professionnel élégant.
              <br />
              ...
              vous pourrez être vous- même et ou chaque image sera travaillée
              avec soin pour capturer l’essence de votre personnalité.
            </p>
          </div>
          <div className={styles.container}>
            <Image
        ...
        <main>
          <div style={{ textAlign: "center", fontFamily: "Inria serif" }}>
            ...
            <p className={styles.presentation}>
              ...
              Que ce soit pour célébrer un moment de votre vie, une nouvelle
              étape ou simplement pour vous reconnecter à vous- même, cette
              séance vous permet de prendre le temps de vous regarder sous un
              autre angle, loin des jugements extérieurs.
      ...
      <div>
        <main>
          <div style={{ textAlign: "center", fontFamily: "Inria serif" }}>
            <h1>Séance TBB</h1>
            <p className={styles.presentation}>
              La séance photo lors d’un TBB est une expérience exceptionnelle
              qui permet de capturer un moment rare et précieux dans la vie de
              votre bébé. <br />
              ...
              non seulement de conserver des souvenirs inestimables, mais aussi
              de revivre ces instants de douceur et de complicité.
            </p>
          </div>
          <div className={styles.container}>
            <Image
      ...
      <div>
        <main>
          <div style={{ textAlign: "center", fontFamily: "Inria serif" }}>
            ...
            <p className={styles.presentation}>
              Le pack duo grossesse-naissance vous permet de capturer deux
              moments inoubliables : la beauté de votre grossesse et les
              premiers instants de vie de votre bébé.
              <br /> En combinant ces deux séances photo, vous bénéficiez non
              seulement de souvenirs précieux, mais également d'une réduction
              sur le motant total.
              <br />
              <br />
