        ...
        <div className={styles.container}>
          ...
          <div className={styles.description}>
            <div>
              ...
              <h2 className={styles.h2}>Durée de la séance : 30 min</h2>
              <span className={styles.price}>150 €</span>
              <p className={styles.p}>
                Inclus : Galerie complète envoyée (environ 50 photos)
              </p>
            </div>
            <div>
              <Link href="/contact">
        ...
        <div className={styles.container}>
          <div className={styles.description}>
            <div>
              ...
              <h2 className={styles.h2}>Durée de la séance : 45 min</h2>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.description}>
            <div>
              ...
              <h2 className={styles.h2}>Durée de la séance : 1h</h2>
...
export default FormuleGrossesse;
